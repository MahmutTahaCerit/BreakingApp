...
class SportsTableViewController: UITableViewController{
    ...
    private func dataFetch(){
        guard let url = URL(string: "https://newsapi.org/v2/top-headlines?country=tr&pageSize=100&category=sports&apiKey=\(apiKey)")else { return}
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "toSportsDetailVC", sender: nil)
    }
