...
class GeneralTableViewController: UITableViewController{
    ...
    private func dataFetch(){
        guard let url = URL(string: "https://newsapi.org/v2/top-headlines?country=tr&pageSize=100&category=general&apiKey=\(apiKey)")else { return}
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "toGeneralDetailVC", sender: nil)
    }
